...
if __name__=="__main__":
    ...
    pub_steer = rospy.Publisher('/model4_new/steering_controller/command', Float64, queue_size=10) # Add your topic here between ''. Eg '/my_robot/steering_controller/command'
    ...
    pub_move4 = rospy.Publisher('/model4_new/drive_wheel4_controller/command', Float64, queue_size=10) # Add your topic for move here '' Eg '/my_robot/longitudinal_controller/command'
    ...
    try:
        ...
        while(1):
            ...
            if key in moveBindings.keys():
                control_speed = control_speed - moveBindings[key][0]
                control_turn = control_turn + moveBindings[key][1]*5*3.14/180
                count = 0
            ...
            pub_steer.publish(control_turn) # publish the turn command.
            #pub_left.publish(control_turn) # publish the turn command.
            pub_move1.publish(control_speed) # publish the control speed. 
